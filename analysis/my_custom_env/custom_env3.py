...
class CustomEnv3(gym.Env):
    def __init__(self,grid_size = gridsize[envselector], max_steps=  maxsteps[envselector], goalselector = goalselector):
        ...
        # Load the dataset
        try:
            self.dataset = h5py.File('/home/paperspace/decision-diffuser/code/analysis/newdataset/withoutGoal/env3-con.hdf5', 'r')
        ...
        self.goal_position = (9,9) #(np.random.randint(self.num_rows-1, self.num_rows-1), np.random.randint(self.num_rows-1, self.num_rows-1))
    ...
    def reset(self, *, seed=None, options=None):
        ...
        self.obstacle_positions = [(6,1), (6,6)]
        self.starting_pos, self.goal_position = self.generate_valid_start_goal()
        self.agent_position = self.starting_pos
        self.visited_positions = []
        self.current_step = 0
        infodict = {}
