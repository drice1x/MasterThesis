...
class CustomEnv1(gym.Env):
    def __init__(self,grid_size = gridsize[envselector], max_steps=  maxsteps[envselector]):
        ...
        # Load the dataset
        try:
            self.dataset = h5py.File('/home/paperspace/decision-diffuser/code/analysis/newdataset/withoutGoal/my_datasetExperiment1.hdf5', 'r') #env1-con #my_datasetExperiment1
    ...
    def _calculate_reward(self, new_position):
        ...
        #prev_distance = abs(goal_row - self.agent<_position[0]) + abs(goal_col - self.agent_position[1])
