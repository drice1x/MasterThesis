...
class ReplayBuffer:
    ...
    def add_path(self, path):
        ...
        if path['terminals'].any() and self.termination_penalty is not None: ##aaron: gucken was das macht. musste env anpassen dafür
            if path['timeouts'].any():
                print("schlecht- debug")
